...
public class Push {
    ...
    let requestApi: HttpRequestProtocol
     ...
     */
    init(_ mobileConfig: MobileService?, _ requestApi: HttpRequestProtocol) {
    ...
    */
    public func register(_ deviceToken: Data,
        ...
        let registerUrl = pushConfig.url.appendingPathComponent(Push.apiPath).absoluteString
    ...
    fileprivate func saveClientDeviceInformation(_ token: Data, _ serverURLGuard: URL) {
        ...
        UserDefaults.standard.set(token, forKey: Push.deviceTokenKey)
    }
